...
Public Class Date_Time
		...
		Public Function format(date_time As DateTime, Optional return_format As String = "")
		...
		Public Function timestamp(Optional unique_suffix As String = "000000")
			'// RETURNS UNIQUE 24 DIGIT TIMESTAMP
			Dim seed As DateTime = DateTime.Now
			Return Left(Right("0000" + seed.Year, 4) + seed.Month.ToString("0#") + seed.Day.ToString("0#") + seed.Hour.ToString("0#") + seed.Minute.ToString("0#") + seed.Second.ToString("0#") + Left(seed.Millisecond + "0000", 4) + Right("00000000" + unique_suffix, 6) + "00000000000000000000000000",24)
		End Function
